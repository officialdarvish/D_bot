...
|---|---|
| 🤖 Telegram user panel | Buy services, manage configs, renew services, delete configs, wallet, tickets and guides |
| 🖥️ Web admin panel | Manage users, plans, categories, servers, payments, reports, test accounts and settings |
| 👥 Reseller system | Reseller packages, traffic balance, reseller users and unused-volume refund on deletion |
...
| 💳 Wallet & payments | Wallet payments, card-to-card receipt approval and order tracking |
