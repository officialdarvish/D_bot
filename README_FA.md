...
| بخش | توضیحات |
|---|---|
| 🤖 پنل کاربر تلگرام | خرید سرویس، مدیریت کانفیگ‌ها، تمدید، حذف کانفیگ، کیف پول، تیکت و راهنما |
| 🖥️ پنل مدیریت وب | مدیریت کاربران، پلن‌ها، دسته‌بندی‌ها، سرورها، پرداخت‌ها، گزارش‌ها، تست اکانت و تنظیمات |
| 👥 سیستم نمایندگی | بسته‌های نمایندگی، موجودی حجم، کاربران نماینده و برگشت حجم مصرف‌نشده هنگام حذف |
...
| 💳 کیف پول و پرداخت | پرداخت از کیف پول، پرداخت کارت‌به‌کارت، تایید رسید و پیگیری سفارش |
