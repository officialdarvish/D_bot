...
type PlanItem = { id: number; title: string; volume_gb: number; duration_days: number; price_irt: number; category_id?: number; server_id?: number; inbound_ids?: unknown[]; is_active: boolean; is_unlimited?: boolean };
