...
from app.services.referral_service import maybe_grant_invite_reward
...
async def initial_setup_welcome(message: Message, state: FSMContext):
    ...
    await message.answer(
        '✅ راه‌اندازی اولیه با موفقیت تکمیل شد.\n\nاکنون منوی مدیریت در دسترس است.',
        reply_markup=main_menu_inline(True, await is_test_visible(), True),
    )
