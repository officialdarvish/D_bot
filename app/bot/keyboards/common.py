...
def bot_settings_inline() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=BTN_ANTI_SHARING, callback_data=CB_ANTI_SHARING), InlineKeyboardButton(text=BTN_WEBSITE_SETTINGS, callback_data='admin:website_settings')],
        [back_button(CB_BACK_ADMIN)],
    ])
