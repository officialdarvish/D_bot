...
async def scan_service_alerts(bot):
    ...
    async with SessionLocal() as session:
        q = (
            ...
            .where(
                or_(
                    and_(ClientService.total_bytes > 0, (ClientService.total_bytes - ClientService.used_bytes) <= 1024**3, ClientService.notify_1gb_sent == False),
                    and_(ClientService.total_bytes > 0, (ClientService.total_bytes - ClientService.used_bytes) <= 100*1024**2, ClientService.notify_100mb_sent == False),
