...
def _backup_models():
    return [
        ...
        ('test_account_counters', TestAccountCounter), ('service_username_counters', ServiceUsernameCounter),
    ]
...
def _restore_delete_order():
    return [
        ...
        TestAccountCounter, ServiceUsernameCounter, ServerCategory, Server, Setting, User,
    ]
