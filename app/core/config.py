...
class Settings(BaseSettings):
    ...
    XUI_CA_BUNDLE: str = ''
    # 3x-ui/Sanaei can become slow while expiring/enabling clients. Keep these
    # configurable so transient panel latency does not abort renewals.
    XUI_CONNECT_TIMEOUT_SECONDS: float = 8.0
    XUI_READ_TIMEOUT_SECONDS: float = 35.0
